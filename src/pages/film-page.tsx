...
import { getFromJsonToMovies, getRandomMovie } from '../utils/utils';
...
function FilmPage(props: FilmPageProps) {
  ...
  const getMovie = () => {
    ...
    const movieMock = moviesMockById.find((movie) => movie.id === Number(filmId));
    return movieMock;
  };
          ...
          <FilmContent className='film__content'>
            <div className='film__params'>
              <List className='film__list list list-reset'>
                ...
                <li className='list__item'>{getRandomItem(movie.genres)}</li>
