    ...
    <SamplePage {...props}>
            ...
            <div className='film__params'>
              <List className='film__list list list-reset'>
                <Rating className='list__item'>
                  ...
                  <RatingValue className='list__item-value'>7,5</RatingValue>
                </Rating>
      ...
      <section className='about'>
        ...
        <Wrapper className='wrapper'>
          ...
          <Label>Бюджет</Label>
          <Value>250 000 руб.</Value>

          <Label>Выручка</Label>
          <Value>2 835 000 руб.</Value>

          <Label>Режиссёр</Label>
          <Value>Игорь Масленников</Value>

          <Label>Продакшен</Label>
          <Value>Ленфильм</Value>

          <Label>Награды</Label>
          <Value>Топ-250, 33 место</Value>
        </Wrapper>
      </section>
    </SamplePage>
  );
