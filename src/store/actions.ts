...
import type { IFavorite, IAuthInfo, IMovie } from "../types/types";
...
const addFavorites = createAction<IFavorite[]>(
  `${NameSpace.Favorites}/addFavorites`,
); ///async;
const delFavoriteFilm = createAction<IFavorite>(
  `${NameSpace.Favorites}/delFavoriteFilm`,
); //async;
